...
import {Accessory, TvConfig} from './Accessory';
...
export class Platform implements DynamicPlatformPlugin {
  ...
  discoverDevices() {
    ...
    const devices: TvConfig[] = this.config.devices as TvConfig[];
    ...
    for (const device of devices) {
      ...
      const uuid = this.api.hap.uuid.generate(
        `@jappyjan--tasmota-mqtt-ir_${device.identifier}_${device.name}`,
      );
